...
from dataset_Kfold_dataAug_newAge import MaskBaseDataset
...
def train(data_dir, model_dir, folder_name, args):
    ...
    dataset_module = getattr(import_module("dataset_Kfold_dataAug_newAge"), args.dataset)  # default: MaskBaseDataset
    ...
    transform_module = getattr(import_module("dataset_Kfold_dataAug_newAge"), args.augmentation)  # default: BaseAugmentation
...
if __name__ == '__main__':
    ...
    now = datetime.now()
    folder_name = 'exp Kfold dataAug ' + now.strftime('%Y-%m-%d-%H:%M:%S')
