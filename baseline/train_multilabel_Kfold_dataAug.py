...
from dataset_Kfold_dataAug import MaskBaseDataset
...
def train(data_dir, model_dir, folder_name, args):
    ...
    dataset_module = getattr(import_module("dataset_Kfold_dataAug"), args.dataset)  # default: MaskBaseDataset
    ...
    transform_module = getattr(import_module("dataset_Kfold_dataAug"), args.augmentation)  # default: BaseAugmentation
